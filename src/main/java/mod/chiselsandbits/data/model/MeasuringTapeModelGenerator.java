...
public class MeasuringTapeModelGenerator extends ItemModelProvider
{
    ...
    protected void registerModels()
    {
        getBuilder("measuring_tape")
          ...
          .texture("layer0", new ResourceLocation(Constants.MOD_ID, "tape_measure"))
          .transforms()
          ...
          .end()
          .override()
          .predicate(new ResourceLocation(Constants.MOD_ID, "isMeasuring"), 1)
          .model(new ModelFile.UncheckedModelFile(new ResourceLocation(Constants.MOD_ID, "measuring_tape_is_measuring")))
          .end();

        getBuilder("measuring_tape_is_measuring")
          .parent(getBuilder("measuring_tape"))
          .texture("layer0", "tape_measure_is_measuring");
    }
}
