...
public class InteractionISTER extends BlockEntityWithoutLevelRenderer
{
      ...
      final int combinedOverlay)
    {
        ...
        if (item.isInteracting(stack)) {
            ...
            itemRenderer.render(stack, ItemTransforms.TransformType.NONE, false, matrixStack, buffer, combinedLight, combinedOverlay, innerModel);
        ...
        else
        {
            ...
            itemRenderer.renderStatic(target, ItemTransforms.TransformType.NONE, combinedLight, combinedOverlay, matrixStack, buffer, 0);
        }
