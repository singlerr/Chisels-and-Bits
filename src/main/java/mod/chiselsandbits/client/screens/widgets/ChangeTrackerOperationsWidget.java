...
public class ChangeTrackerOperationsWidget extends AbstractChiselsAndBitsWidget
{
    ...
    {
        super.init();
        this.undoButton = owner.addButton(
          new GuiIconButton(
            this.x,
            this.y,
        ...
        this.redoButton = owner.addButton(
          new GuiIconButton(
            this.x,
        ...
        this.clearButton = owner.addButton(
          new GuiIconButton(
            this.x,
    ...
    @Override
    public void renderButton(final @NotNull MatrixStack matrixStack, final int mouseX, final int mouseY, final float partialTick)
    {
        //Noop
    }
