...
public class ToolModeSelectionWidget<M extends IToolMode<G>, G extends IToolModeGroup> extends AbstractChiselsAndBitsWidget
{
    ...
    @Override
    public void renderButton(final @NotNull MatrixStack stack, final int mouseX, final int mouseY, final float partialTickTime)
    {
        //Noop.
    ...
    private void rebuildPagingControl() {
        ...
        this.pageSelectionWidget = owner.addButton(new RadialSelectionWidget(
          this,
          PAGING_WIDGET_SIZE,
          PAGING_WIDGET_SIZE,
    ...
    private void rebuildPageControl() {
        ...
        this.currentPageSelectionWidget = owner.addButton(new RadialSelectionWidget(
          this,
          MAIN_WIDGET_SIZE,
          MAIN_WIDGET_SIZE,
    ...
    private void rebuildGroupControl() {
        ...
        {
            this.currentGroupSelectionWidget = owner.addButton(new RadialSelectionWidget(
              this,
              OUTER_WIDGET_SIZE,
              OUTER_WIDGET_SIZE,
