...
public class ChiseledBlockBakedQuad extends BakedQuad
{
    ...
    public static class Builder implements IVertexConsumer, IFaceBuilder
    {
        ...
        public BakedQuad create(
          final TextureAtlasSprite sprite)
        {
            return new ChiseledBlockBakedQuad(unpackedData, tint, orientation, sprite);
        }
