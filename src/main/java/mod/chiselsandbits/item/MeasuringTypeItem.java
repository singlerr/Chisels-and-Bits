...
public class MeasuringTypeItem extends Item implements IMeasuringTapeItem
{
    public MeasuringTypeItem(final Properties properties)
    {
        super(properties);
    }
