...
public class PlacementResult
{
    ...
    {
        return new PlacementResult(true, clientColor, TextComponent.EMPTY);
    }
    ...
    {
        return failure(clientColor, TextComponent.EMPTY);
    }
    ...
    {
        return new PlacementResult(true, color, TextComponent.EMPTY);
    }
    ...
    {
        return failure(color, TextComponent.EMPTY);
    }
