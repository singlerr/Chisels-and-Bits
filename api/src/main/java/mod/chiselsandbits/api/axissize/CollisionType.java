...
{
    NONE_AIR(BlockStatePredicates.NOT_AIR, Blocks.STONE.defaultBlockState()),
    COLLIDEABLE_ONLY(BlockStatePredicates.COLLIDEABLE_ONLY, Blocks.STONE.defaultBlockState()),
    ALL(BlockStatePredicates.ALL, Blocks.AIR.defaultBlockState());

    private final Predicate<BlockState> isValidFor;
    private final BlockState exampleState;

    CollisionType(final Predicate<BlockState> isValidFor, final BlockState exampleState) {this.isValidFor = isValidFor;
