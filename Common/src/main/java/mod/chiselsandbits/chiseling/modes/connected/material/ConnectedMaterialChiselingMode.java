...
public class ConnectedMaterialChiselingMode extends SimpleChiselsAndBitsRegistryEntry implements IChiselMode
{
    ...
    )
    {
        ...
        while(!toProcess.isEmpty()) {
            ...
            if (target.getState().equals(targetedInfo.get().getState()) || target.getState().isAir()) {
